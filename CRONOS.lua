...
infoTab:Show()
infoTab:AddLabel("BY KARMA").TextSize = 20
infoTab:AddLabel("https://chat.whatsapp.com/FdeIXblUSVKFCO5GV6MgCb?mode=gi_t").TextSize = 20
infoTab:AddButton("Copy Invite", function()
    local link = "https://chat.whatsapp.com/FdeIXblUSVKFCO5GV6MgCb?mode=gi_t"
    if setclipboard then
        setclipboard(link)
        game.StarterGui:SetCore("SendNotification", {
            Title = "Link Copied!";
            Text = "unanse al clan FZK🔥.";
            Duration = 3;
        })
    else
        game.StarterGui:SetCore("SendNotification", {
